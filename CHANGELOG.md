...
- Verifiable Presentation verification flow via `VerifyPresentation` with optional checks for proof, expiration, embedded credential validation, audience, and nonce
